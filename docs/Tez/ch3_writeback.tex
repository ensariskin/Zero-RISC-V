...
Her kesinleştirme sinyali, serbest listenin yazma portuna bağlıdır. Kesinleştirme geçerli olduğunda, ilgili ROB indeksi serbest listeye eklenmektedir. Üç paralel yazma portu sayesinde her çevrimde üç adres serbest bırakılabilmektedir. Burada gerçek bir yazma işlemi yoktur, bu yapılan işlem sonucunda sadece serbest listeyi tutan dairesel tamponun pointer değeri arttırılmış olur.
