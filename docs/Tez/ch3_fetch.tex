...
Tahmin indeksi, program sayacı değeri ile küresel geçmiş kaydının XOR işlemine tabi tutulmasıyla hesaplanmaktadır. Bu indeks, iki bitlik doyurma sayaçlarından oluşan bir tabloya erişmek için kullanılmaktadır. Sayacın en anlamlı biti, dalın tahmin edilen yönünü belirlemektedir.
...
\paragraph{İki Bitlik Sayaç Tahmincisi}
...
\paragraph{Tahmin Bilgisinin Paketlenmesi}
